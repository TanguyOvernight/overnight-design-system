# Univers investissable — émergents depuis la France, route PEA

**Constitué le 02/08/2026** (chantier ouvert le 31/07 après un 0 signal sur
le terrain émergents). Propriétaire unique de cette information ; les autres
fichiers y renvoient, ils ne recopient pas.

**Pourquoi ce fichier existe** : la contrainte d'achetabilité élimine ~90 %
du champ émergent avant même la recherche (Bombay, Shanghai/Shenzhen,
São Paulo, Jakarta, Bangkok, Séoul, Taipei, Johannesburg, Istanbul : toutes
inaccessibles). **On ne peut pas détecter une exposition sous-estimée sans
référentiel de comparaison.** La seule route PEA vers les émergents est une
société cotée à Euronext dont le CA vient des pays émergents —
**18,6 % de fiscalité après 5 ans contre 31,4 % en CTO**, soit 12,8 points
de rendement net.

---

## 🔑 LES CINQ ENSEIGNEMENTS DU CHANTIER

**1. La route PEA existe, mais elle passe par Lisbonne et Bruxelles — pas
par Paris.** Les deux seules sociétés dont la majorité *chiffrée et sourcée*
du CA consolidé vient des émergents sont portugaises : **Mota-Engil (78 %)**
et **Jerónimo Martins (~79 %)**. Paris n'offre presque que de l'exposition
*par les actifs* (Eramet, Maurel & Prom) ou par la distribution aval
(Rubis). **Il n'existe pas d'équivalent français d'un Jerónimo Martins.**

**2. Trois natures d'exposition émergente, qui ne valent PAS la même chose :**
- **(a) CA consolidé émergent** — Mota-Engil, Jerónimo Martins, AB InBev.
- **(b) Actifs 100 % émergents, ventes facturées ailleurs** — Sipef facture
  34,3 % en Suisse et 10,1 % à Singapour (**ce sont des desks de négoce** ;
  les 85 814 ha sont en Indonésie, Papouasie-NG et Côte d'Ivoire). Idem
  Eramet, AMG.
...
> et donc, potentiellement, le moins couru.** C'est là qu'il faut chercher.

**3. Les secteurs qu'on attendrait pleins sont vides, et le champ a
RÉTRÉCI.** Aucune banque à réseau émergent purement Euronext. Aucune
télécom ou tour émergente (Millicom = Stockholm/Nasdaq, hors périmètre). La
distribution africaine cotée à Paris a disparu **avec le retrait de CFAO**.
La logistique portuaire africaine est sortie de la cote **avec la cession
Bolloré**. → **Le 0 signal du 31/07 n'était pas une malchance : il était
mécanique.**

**4. Le prix unitaire n'est PAS le frein craint — le vrai frein est
l'accès courtier.** Aucune des 12 sociétés ne dépasse le plafond de ~209 € ;
la médiane est autour de 30 €, et les deux profils les plus purement
émergents ont les meilleurs tickets (Mota-Engil 4,67 €, Maurel & Prom
8,12 €).
> ⚠️ **ACTION EN ATTENTE — bloquante pour la moitié de cet univers** :
> vérifier que Fortuneo route bien **Euronext Lisbonne et Bruxelles**.
> **L'éligibilité PEA ne garantit PAS l'accès du courtier.** Sans cette
> vérification, Mota-Engil, Jerónimo Martins, AB InBev, Sipef et Ageas ne
> sont accessibles que sur le papier.

**5. Six cotations périmées rencontrées en une seule session.** Euronext
Live affichait Mota-Engil à 3,26 € (réel ~4,67 €) et Maurel & Prom à 5,59 €
(réel ~8,12 €) ; un agrégateur donnait Jerónimo Martins à 16,60 € « au
3 juillet » quand capi ÷ actions donne 22,72 € ; la capi AB InBev de
« 138,74 Md » est en **dollars**, pas en euros ; et un article portugais
présentant un résultat semestriel « +65 % à 49 M€ » le comparait à 2023 —
**archive de 2024**. **Aucun prix de ce fichier n'a été retenu sans un
second ancrage de nature différente.** La règle 17 a mordu six fois en une
session.

---

## GROUPE A — CA consolidé majoritairement émergent (le cœur de cible)

| | **Mota-Engil** | **Jerónimo Martins** | **AB InBev** |
|---|---|---|---|
| **Ticker / place** | EGL — **Lisbonne** (PSI) | JMT — **Lisbonne** (PSI) | ABI — **Bruxelles** (BEL 20) |
| **Capitalisation** | ~**1,43 Md€** (306 775 950 actions × 4,67 € au 31/07). ⚠️ Investing affiche 1,56 Md€ non daté → écart 8 %, **non résolu** | **14,30 Md€** (contrôle : 14,30 Md ÷ 22,72 € = 629,4 M titres ✓) | ~**128 Md€** (1,80 Md titres × 71,28 €) |
| **% CA émergent** | **78,0 %** ✅ Afrique 2 129 M€ (+22 %) + LatAm 2 006 M€ (−33 %) sur 5 301 M€ — rapport annuel 2025 | **~79 %** ✅ Biedronka Pologne 25,3 Md€ (70,3 %) + Ara Colombie 3,2 Md€ (8,9 %) sur 36 Md€. ⚠️ **Dépend du classement de la Pologne en EM** : MSCI oui, FTSE non | **~57 % + Afrique** — Middle Americas 26 %, South America 21 %, APAC 10 %, Afrique dans EMEA 18 % |
| **Secteur** | Construction, **contract mining** (top 5 mondial, n°1 africain), concessions | Distribution alimentaire discount | Brasseur |
| **Prix unitaire** | **4,67 €** — le meilleur ticket de l'univers | **22,72 €** | **71,28 €** |
| **Liquidité** | non mesurée | ~15 M€/jour | très liquide (BEL 20) |
...
|---|---|---|---|
| **Ticker / place** | SIP — **Bruxelles** | MAU — **Paris** | ERA — **Paris** |
...
| Société | Ticker / place | Capitalisation | Exposition émergente | Prix | Prochaine pub. |
|---|---|---|---|---|---|
| **Ageas** | AGS — **Bruxelles** | **13,73 Md€** (205 727 286 × 66,75 € ✓) | **52 % du RÉSULTAT opérationnel net** : 860 M€ d'Asie sur 1 650 M€ ; **26 M de clients asiatiques** ; passifs vie tirés par la Chine (+14 %) | 66,75 € | S1 ~fin août (réf. 27/08/2025) |
| **Heineken** | HEIA — Amsterdam | non fiabilisée | **~45-50 % [ESTIMATION]** — Afrique/MO 14,6 % (CA **+15,7 %**, RO **+62 %**), APAC 13,6-14 %, + part LatAm des Amériques (32,6 % non ventilé) | 75,24 € | **S1 le 05/08/2026** |
| **Vallourec** | VK — Paris | **5,08 Md€** (÷ 20,56 € = 247 M titres ✓) | **~38 % du CA Tubes** : Amérique du Sud 16 % + Moyen-Orient 22 % | 20,56 € | Q2 publié le 30/07 |
| **SBM Offshore** | SBMO — Amsterdam | **5,39 Md€** (÷ 32,18 € = 167,5 M ✓ — **ancrage de qualité : rachats déclarés à 32,18 € de moyenne du 16 au 22/07**) | Brésil / Guyana / Angola — % non chiffré | 32,18 € | **S1 le 06/08/2026** |
...
- **AMG Critical Materials** (Amsterdam) — usines au Brésil, Mozambique,
  ...
  4,0 %, Afrique 0,2 %**. Exposition émergente **par les coûts**, pas par la
  demande. Ne remplit pas le critère.
- **Galp Energia** (Lisbonne) — amont Brésil/Angola/Mozambique/Namibie, mais
  CA dominé par le raffinage-distribution ibérique ; **ventilation CA vs
  EBITDA non réconciliée**. À documenter avant inclusion.
- **Prosus** (Amsterdam) — 🔴 **exclusion temporaire par la règle 17.** Trois
  sources donnent trois univers incompatibles : 38,50 € au 21/07 ; capi
  84,29 Md€ ; capi 215,56 Md$ sur 2,31 Md de titres (⇒ ~86 €/titre) ;
  184,56 Md€ « sur un cours de 36,76 € » (arithmétiquement impossible).
  **Le rapport du simple au double sur le cours n'a pas été tranché** —
  écrire un prix ici serait l'erreur Sidetrade. À reprendre sur écran de
  courtier.
- **Bekaert** (Bruxelles) — CA 2025 de 3,7 Md€ (−6 %), sortie annoncée des
  activités commoditisées d'Amérique latine, ventilation régionale
  introuvable dans le budget.

---

## À INSTRUIRE EN PRIORITÉ (aucun plaidoyer, aucune recommandation)

1. **Mota-Engil (EGL, Lisbonne)** — seule société combinant exposition
   émergente majoritaire *documentée au CA consolidé* (78 %), ticket
   compatible avec la poche mensuelle (4,67 €) et catalyseur daté proche
   (S1 fin août). À instruire d'abord sur **la liquidité réelle** et **la
   structure de dette d'un contract miner**.
2. **Sipef (SIP, Bruxelles)** — cas d'école du terrain invisible : 100 % des
   actifs en Indonésie/PNG/Côte d'Ivoire mais un split de ventes affichant
   « Suisse 34 % », donc **structurellement mal classée par les screeners**.
   À instruire contre son plus haut historique franchi en 2026 et son
   flottant. **S1 le 12/08.**
3. **Ageas (AGS, Bruxelles)** — seule voie Euronext vers l'assurance-vie
   asiatique de masse. Difficulté propre : **JV non consolidées** → à
   instruire sur le **cash qui remonte réellement à Bruxelles**.

## Trous à combler dans une session ultérieure

- **Liquidité quotidienne : non mesurée pour 10 des 12.**
- Cotation Prosus à trancher ; ventilations Galp et Bekaert ; % de CA
