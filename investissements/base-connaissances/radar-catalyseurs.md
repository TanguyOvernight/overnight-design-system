...
|---|---|---|---|---|
| **Séché SCHP (PEA)** — 📅 **date S1 CONFIRMÉE : mercredi 09/09/2026, après bourse** *(⚠️ source agrégateur unique, à reconfirmer sur groupe-seche.com)* | S1 : EBE ≥ 125 M€ ET France organique ≥ 0 % ET guidance 275-285 M€ confirmée ET cours ≤ 90 € → **tranche 1 = min(L)/3, soit ~43 € à V actuel** 🔴 *(corrigé le 27/08 — l'ancien « ~150 € » DÉPASSAIT le plafond de ligne L = 130 €. Écrire une tranche en euros fixes la périme en silence ; la formule, non)* ; arrêté strict + quantification PFAS → tranche 2 conditionnelle (plafond 5 %) | Publication S1 (butée 30/09/2026) ; point intermédiaire : arrêté boues (été 2026) | 3e warning OU EBE S1 < 110 M€ OU arrêté ≥10x plus laxiste/reporté au-delà du 01/01/2027 → PASSE auto | C012 |
