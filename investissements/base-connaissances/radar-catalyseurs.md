...
| **04/08** (6h30 EDT) | **Résultats T2 2026 Stevanato Group (STVN, NYSE — CTO)** | Chasse santé 04/08 : **verdict SUSPENDU, pas écrit** — le titre publiait le matin même où le Chasseur l'a trouvé, et signaler à quelques heures d'une publication c'est **parier sur un événement**. Profil recherché : *fournisseur que le marché price sur le donneur d'ordre* — verre pharmaceutique et seringues préremplissables, **le contenant des GLP-1**. Le marché price Lilly et Novo ; Stevanato encaisse le volume **quel que soit le vainqueur**. T1 2026 : CA 274 M€ (+10 % à changes constants), seringues préremplissables **+20 %**, **GLP-1 = 21-22 % du CA**. Capacités US (Fishers, Indiana) et Latina « quasi achevées » — **la capacité américaine est déjà bâtie et payée** au moment où la relocalisation devient une contrainte pour ses clients. ⚠️ **T3 drapeau** : TD Cowen a déjà écrit la thèse (initiation *Buy*, objectif 25 $, « les actions pricent trop de scepticisme »). ⚠️ **T4 = le test décisif** : cash-flow libre / EBITDA **après** achèvement du capex — une capacité « quasi achevée » doit faire basculer le FCF ; sinon c'est un piège à capital. ⚠️ **T6 non instruit** (contrôle familial, structure duale). **Aucun seuil écrit** : il ne peut s'écrire qu'après cotation post-publication (règle 3) |
