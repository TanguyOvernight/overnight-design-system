...
|---|---|---|---|---|
| **Séché SCHP (PEA)** — 📅 **date S1 CONFIRMÉE : mercredi 09/09/2026, après bourse** *(⚠️ source agrégateur unique, à reconfirmer sur groupe-seche.com)* | **S1 : EBE ≥ 125 M€ (mesuré sur le PUBLIÉ) ET France organique ≥ 0 % ET 🔴 guidance **260-270 M€** confirmée *(CORRIGÉ le 30/08 : le « 275-285 » était le chiffre sorti de l'avertissement n°1, ABANDONNÉ le 09/03/2026 — soit 4 mois avant l'écriture du contrat. Une condition inatteignable ne se déclenche jamais)* ET cours ≤ 90 €** → tranche 1 = min(L)/3. 🔎 **LECTURES OBLIGATOIRES le 9 au soir** : ① l'**EBE à périmètre constant** (contre **102,4 M€**, le publié 118,2 contenant déjà +15,8 M€ de périmètre ECO, et le S1 2026 contenant La Filippa + Hidronor) — une hausse publiée peut masquer un recul organique ; ② **l'ORIGINE de toute baisse du levier** — les 300 M€ d'hybrides du 02/10/2025 sont en capitaux propres, et expliquent 300,9 M€ des 300,9 M€ de désendettement 2025 : l'organique est NUL, le levier retraité est 3,8x et non 2,3x| Publication S1 (butée 30/09/2026) ; point intermédiaire : arrêté boues (été 2026) | 3e warning OU EBE S1 < 110 M€ OU arrêté ≥10x plus laxiste/reporté au-delà du 01/01/2027 → PASSE auto | C012 |
...
| **STM (STMPA, PEA)** — 🔴 *contrat RESSERRÉ le 26/08* | **Clôture Euronext Paris DATÉE ET OBSERVÉE ≤ 42,00 €** *(VWAP, prix dérivé, `capi ÷ titres` ou instantané ne déclenchent JAMAIS)* ET **P/E fwd < 30x sur consensus BPA 2027 PUBLIÉ** *(spécifié le 26/08 : la perte nette du S1 rend tout multiple trailing inexploitable)* ET **≥ 1 trim. de MB PUBLIÉE en hausse séquentielle** vers 40 %+. 🚨 **Tranche 1 = min(L)/3 ≈ 43 € à V actuel — PAS 150 €** | Résultats T3, **butée stricte 31/10/2026** · contrôle hebdo gratuit : **déclaration MAR du vendredi, la prochaine (~31/08) DOIT partir de 19 224 908 titres** | T3 sans les 3 conditions → **PASSE**. 🔒 **Renouvellement CONSOMMÉ PAR AVANCE le 26/08 → le PASSE sera DÉFINITIF.** 🔴 **KILL ANTICIPÉ : 2ᵉ période consécutive de perte nette au T3** | C007 · **C048** · **C049** |
...
| **Fin oct.** (date à confirmer) | **Résultats T3 2026 Technip Energies (TE, Euronext Paris, PEA)** | Chasse industrie 05/08 : **écartée par T2**, mais journalisée avec ses conditions de qualification. S1 publié le 30/07 : **carnet record 25 Md€ (~3,5 ans de CA — 🔴 CORRIGÉ le 26/08, voir encadré), book-to-bill 3,5x** — mais **EBITDA récurrent 212 M€ contre 319 M€**, marge tombée à **5,8 % contre 8,7 %**, et **guidance de marge Project Delivery abaissée de 6,5-7,5 % à « > 5,0 % »** (perturbations Hormuz). Titre **−10,24 % le jour même**, à **29,74 € au 04/08** (−30,5 % sous son plus haut 52 sem., capi 5,14 Md€ — 🔴 **~~prix réconcilié par capi ÷ 174,2 M titres ✓~~ — RÉCONCILIATION RETIRÉE le 26/08 : ce chemin est INTERDIT depuis le 15/08**). ✅ **Passe le test 60 $/100 $ le baril** : contracteur payé sur projets déjà signés, le CA 2027-2029 est contractuel — ce n'est pas un pari directionnel sur le pétrole. 🔴 **MAIS drapeau T4 NON LEVÉ** : *carnet record pendant que la marge s'effondre* est le motif exact du **« backlog acheté »** (précédents Saipem, Petrofac), et « recouvrement des coûts attendu, dépendant de discussions commerciales » = **créances de réclamation**, l'accrual le plus agressif du secteur. **Cash-flow opérationnel S1 et trésorerie nette hors avances clients non vérifiés** (403 sur le communiqué primaire). **3 vérifications avant toute réouverture** : (1) cash-flow S1 et trésorerie nette hors avances ; (2) chiffrage explicite et daté de l'impact Moyen-Orient ; (3) **la marge des 12,72 Md€ de commandes prises au S1** — si la direction ne la qualifie pas, l'hypothèse par défaut est qu'elle a acheté du carnet |
