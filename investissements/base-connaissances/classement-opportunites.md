...
**11 candidates actives** (12 − MSFT, sorti par la porte ☠️ TUÉ). Je ne
fabrique pas de 12ᵉ ligne pour tenir le compte.

| Rang | Candidate | Env. | Situation vs déclencheur | Prochaine échéance | Statut | Mvt |
|---|---|---|---|---|---|---|
| **①** | **Cœur World** (hurdle 5 %/an net) | CTO ce mois, PEA ensuite | **400 € de SWDA à exécuter d'ici le 31/07** ; puis en août : 100 € d'ouverture PEA + 400 € WPEA | **immédiat** | 🟢 | = |
| **②** | **Or** (assurance) | CTO | **100 € d'IAU à exécuter d'ici le 31/07** (comptant, levier x1) ; ~4 100 $/oz | **immédiat** | 🟢 | **▲ +6** |
| **③** | **Vicat** (ciment) | PEA | ~62 € vs **≤ 56 €** (−10 %) — contrat RÉÉCRIT à deux portes | 15/03/2027 | 🟡 | ▼ −1 |
| **④** | **Mobility Global** (CARFAX) | CTO | ~21,7 $ vs ≤ 21 $ (+3,4 %) — **le déclencheur le plus proche du livre** | **07/08** (1ᵉʳˢ résultats) | 🟡 | = |
| **⑤** | **Séché Environnement** | PEA | **~81-82 € vs ≤ 90 € — seule ligne SOUS son prix visé** | S1, butée 30/09 | 🟡 | ▲ +1 |
| **⑥** | **Magnum Ice Cream** | PEA | ~9,6 Md€ vs **≤ 7,6 Md€** (−21 %) — **PASSE**, réouverture sur fait | aucune (fait, pas date) | 🔴 | ▼ −2 |
